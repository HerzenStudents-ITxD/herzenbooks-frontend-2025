type BookPreview = {
  ...
  // Методы API
  export const getBookPreviews = (): Promise<BookPreview[]> => {
  ...
  export const getBookDetails = (id: string): Promise<BookDetails | undefined> => {
