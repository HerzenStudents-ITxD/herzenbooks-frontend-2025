    ...
    return (
        ...
        <div className='home-page flex flex-col w-5/6 mx-auto  items-center'>
            ...
            <div className='flex w-4/6 ml-5'> 
                <img src="logo.svg" alt="LoGO" className="h-27 mt-10"/>
            </div>
            
            <div className='flex w-1/3 flex-col'>
             <div>
                <p className='text-2xl leading-6 mt-15  mx-auto'style={{ fontFamily: 'Futuris' }}>
             ...
             <button 
                ...
                className=' w-25 h-9 p-2 bg-white text-black hover:bg-[rgb(248,80,39)] hover:text-white transition-colors duration-200  py-2 rounded '> 
                найти книгу
            </button>
            </div>
